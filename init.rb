module Heroku::Command
  class Ranger < BaseWithApp
    ...
    def get_status
      ...
      @current_status = Heroku::Helpers::json_decode(resource.get)
      true
    end
    ...
    def delete_dependency_from_url(url)
      dependencies = Heroku::Helpers::json_decode(get_dependencies)
    ...
    def get_watchers
      ...
      @current_watchers = Heroku::Helpers::json_decode(resource.get)
    end
